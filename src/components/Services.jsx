...
const Services = () => {
  return (
    ...
    >
      ...
      <div className=" flex lg:w-2/3 w-full lg:flex-row flex-col justify-evenly items-center gap-10">
        {services.map((item, i) => (
          <div
            key={i}
            className=" shadow-xl rounded-3xl py-8 border max-w-sm md:max-w-sm lg:max-w-lg"
          >
            ...
            <div className=" text-center text-gray-600 font-medium px-5">
              {item.description}
            </div>
          </div>
        ))}
